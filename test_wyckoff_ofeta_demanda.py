...
from wyckoff_ideas.wyckoff_oferta_demanda_projecao import WyckoffOfertaDemandaProjecao
...
wyckoff_oferta_demanda_projecao = WyckoffOfertaDemandaProjecao(df_OHLC)
...
test(wyckoff_oferta_demanda_projecao)